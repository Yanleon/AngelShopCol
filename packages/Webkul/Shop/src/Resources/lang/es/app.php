    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '<a href="https://www.MaxSystems.com" target="_blank">   Hecho en Colombia con <i class="icon-heart"></i> por MaxSystems </a> <span> | Sirnova - Todos los derechos reservados 2025</span>',
                'locale'                 => 'Idioma',
                'newsletter-text'        => '¡No te pierdas lo mejor de Sirnova en tu correo!',
