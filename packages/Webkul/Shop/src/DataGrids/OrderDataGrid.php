    ...
    public function prepareColumns()
    {
        ...
        $this->addColumn([
            ...
            'filterable_options' => [
                ...
                ,
                [
                    'label' =>  trans('shop::app.customers.account.orders.status.options.paid'),
            ...
            'closure'    => function ($row) {
                switch ($row->status) {
                    ...
                    case Order::STATUS_PAID:
                            return '<p class="label-paid">'.trans('shop::app.customers.account.orders.status.options.paid').'</p>';
                }
            },
        ]);
    }
