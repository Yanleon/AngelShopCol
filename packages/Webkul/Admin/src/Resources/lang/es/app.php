        ...
        'themes' => [
            ...
            'create' => [
                ...
                'type' => [
                    ...
                    'promotional-pdf'   => 'PDF de Promociones',
            ...
            'edit' => [
                ...
                'promotional-pdf' => [
                    'title'            => 'Página PDF de Promociones',
                    'description'      => 'Publica un catálogo o folleto promocional en una página independiente de la tienda.',
                    'open-page'        => 'Abrir página pública',
                    'page-title'       => 'Título de la página',
                    ...
                    'view-file'        => 'Ver PDF',
                    'remove-file'      => 'Eliminar el PDF actual al guardar',
                    'public-url'       => 'URL pública',
                    'edit-hint'        => 'Para modificar el contenido del documento, edita el PDF en tu programa habitual y luego reemplázalo aquí.',
                    'preview'          => 'Vista previa',
                    'empty-preview'    => 'Selecciona un PDF para ver una vista previa antes de guardar.',
                ],
                'yes'                           => 'Sí',
            ],
            ...
            'general' => [
                ...
                'social-media' => [
                    ...
                    'facebook' => [
                        ...
                        'icon'  => 'Ícono de Facebook (opcional, deja vacío para usar el predeterminado)',
                    ],
                    'twitter' => [
                        'title' => 'Twitter',
                        'info'  => 'Configurar enlaces de twitter.',
                        'link'  => 'Enlace de Twitter',
                        'icon'  => 'Ícono de Twitter (opcional, deja vacío para usar el predeterminado)',
                    ],
                    'instagram' => [
                        'title' => 'Instagram',
                        'info'  => 'Configurar enlaces de instagram.',
                        'link'  => 'Enlace de Instagram',
                        'icon'  => 'Ícono de Instagram (opcional, deja vacío para usar el predeterminado)',
                    ],
                    'youtube' => [
                        'title' => 'Youtube',
                        'info'  => 'Configurar enlaces de youtube.',
                        'link'  => 'Enlace de Youtube',
                        'icon'  => 'Ícono de Youtube (opcional, deja vacío para usar el predeterminado)',
                    ],
                    'tiktok' => [
                        'title' => 'Tiktok',
