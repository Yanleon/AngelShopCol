...
return [
    ...
    [
        ...
        'name'   => 'Whatsapp',
        'info'   => 'Numero de whatsapp para boton flotante en la tienda',
        'sort'   => 3,
        'fields' => [
            [
                'name'    => 'number',
    ...
    [
        'key'    => 'general.general.whatsapp-mensaje',
        'name'   => 'Mensaje Whatsapp',
        'info'   => 'Mensaje para el boton flotante de whatsapp',
        'sort'   => 4,
        'fields' => [
            [
                'name'    => 'description',
    ...
    [
        ...
        'fields' => [
            [
                ...
                'name'       => 'icon',
                'title'      => 'admin::app.configuration.index.general.social-media.facebook.icon',
                'type'       => 'image',
    ...
    [
        'key'    => 'general.social-media.twitter',
        'name'   => 'admin::app.configuration.index.general.social-media.twitter.title',
        'info'   => 'admin::app.configuration.index.general.social-media.twitter.info',
        'sort'   => 5,
        'fields' => [
            [
                'name'    => 'content',
                ...
                'name'       => 'icon',
                'title'      => 'admin::app.configuration.index.general.social-media.twitter.icon',
                'type'       => 'image',
                'validation' => 'mimes:png,jpg,jpeg,svg,webp',
            ],
        ],
    ...
    [
        'key'    => 'general.social-media.instagram',
        'name'   => 'admin::app.configuration.index.general.social-media.instagram.title',
        'info'   => 'admin::app.configuration.index.general.social-media.instagram.info',
        'sort'   => 2,
        'fields' => [
            [
                'name'    => 'content',
                ...
                'name'       => 'icon',
                'title'      => 'admin::app.configuration.index.general.social-media.instagram.icon',
                'type'       => 'image',
                'validation' => 'mimes:png,jpg,jpeg,svg,webp',
            ],
        ],
    ...
    [
        'key'    => 'general.social-media.tiktok',
        'name'   => 'admin::app.configuration.index.general.social-media.tiktok.title',
        'info'   => 'admin::app.configuration.index.general.social-media.tiktok.info',
        'sort'   => 1,
        'fields' => [
            [
                'name'    => 'content',
                ...
                'name'       => 'icon',
                'title'      => 'admin::app.configuration.index.general.social-media.tiktok.icon',
                'type'       => 'image',
                'validation' => 'mimes:png,jpg,jpeg,svg,webp',
            ],
        ],
    ...
    [
        'key'    => 'general.social-media.youtube',
        'name'   => 'admin::app.configuration.index.general.social-media.youtube.title',
        'info'   => 'admin::app.configuration.index.general.social-media.youtube.info',
        'sort'   => 4,
        'fields' => [
            [
                'name'    => 'content',
                ...
                'name'       => 'icon',
                'title'      => 'admin::app.configuration.index.general.social-media.youtube.icon',
                'type'       => 'image',
                'validation' => 'mimes:png,jpg,jpeg,svg,webp',
            ],
        ],
